...
bit flip
"""
def coupled_flux_qubit_bit_flip_pot(phi_1, phi_2, phi_1dc, phi_2dc, params, phi_1_prefactor = 1, phi_2_prefactor = 1):
    """
    bit flip potential
    """
...
def coupled_flux_qubit_bit_flip_force(phi_1, phi_2, phi_1dc, phi_2dc, params, phi_1_prefactor = 1, phi_2_prefactor = 1):
    """
    2D 4-well potential. Note that M_12 is already normalized with L_1 and L_2.
